...
<head>
    ...
    <title>Database error &mdash; TypeWriter</title>
...
<main>
    ...
    <h1>Fatal Error - <?= $_SERVER['HTTP_HOST'] ?></h1>
    <p>
        This website is currently not available due to a database error. Our tech support
        is already working on a fix. Please check back in about an hour or so!
    </p>
    <hr/>
